...
export default function Profile() {
  ...
  // Comment UI interaction states inside profile view
                ...
                >
                  ...
                  {expandedComments[post.id] ? (
                    <div className="mt-2 pt-3 border-t border-cosmic-border/10 flex flex-col gap-3 transition-all duration-300">
                      ...
                      >
                        <div className="h-7 w-7 rounded bg-gradient-to-tr from-aether-glow/20 to-nebula-teal/20 border border-cosmic-border flex items-center justify-center font-bold text-sm text-aether-glow flex-shrink-0">
                          {user?.avatarText || "Æ"}
                        </div>
                        <input
                          type="text"
                          ...
                          placeholder="Add to the transmission…"
